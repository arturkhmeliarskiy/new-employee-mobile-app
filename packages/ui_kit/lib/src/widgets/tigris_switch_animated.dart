...
class TigrisSwitchAnimated extends StatefulWidget {
  const TigrisSwitchAnimated({
    required this.value,
  ...
  @override
  _TigrisSwitchAnimatedState createState() => _TigrisSwitchAnimatedState();
}

class _TigrisSwitchAnimatedState extends State<TigrisSwitchAnimated>
  ...
  @override
  void didUpdateWidget(TigrisSwitchAnimated oldWidget) {
