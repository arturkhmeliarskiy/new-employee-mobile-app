...
part of 'wdc_onkosten_regel.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

WdcOnkostenregel _$WdcOnkostenregelFromJson(Map<String, dynamic> json) =>
    WdcOnkostenregel(
      json['id'] as String?,
      json['name'] as String?,
      json['date'] as String?,
      json['numberOfUnits'] as String?,
...
Map<String, dynamic> _$WdcOnkostenregelToJson(WdcOnkostenregel instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
      'date': instance.date,
